...
st.title("🚀 내 주식 현황판 (Original Ver.)")
...
def make_df():
    ...
    df['현재가'] = p_list
    df['등락률'] = r_list # 여기에는 무조건 숫자만 들어감 (버그 원천 차단)
...
fig.data[0].texttemplate = (
    "<b><span style='font-size:26px; color:white'>%{label}</span></b><br><br>" +
    "<b><span style='font-size:22px; color:white'>%{customdata[0]:+.2f}%</span></b><br>" +
